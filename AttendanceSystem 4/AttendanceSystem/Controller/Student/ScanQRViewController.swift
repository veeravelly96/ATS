...
class ScanQRViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    func isAttendaceMarked(attendance:AttendanceModel)-> Bool {
        ...
        allAttendance = allAttendance.filter({
            ...
            return ($0.subjectId == attendance.subjectId && $0.section == attendance.section && $0.semester == attendance.semester && $0.facultyId == attendance.facultyId && attendanceDate == myDate)
        })
        
        return allAttendance.count > 0
    }
